...
def launch_setup(context, *args, **kwargs):
    ...
    nodes.append(
        ComposableNode(
            ...
            remappings=[
                ("~/points_raw_ex", "pointcloud_raw_ex"),
                ("~/gnsspose", "gnss_pose"),
                ("~/gprmc", "gprmc"),
                ("~/imu", "imu_raw"),
    ...
    nodes.append(
        ComposableNode(
            package="nebula_decoders",
            plugin="nebula_decoders::PointCloudCroppingComponent",
            name="nebula_pointcloud_cropping_component",
            parameters=[
                {
                    "output_frame": LaunchConfiguration("output_frame"),
                    "vehicle_info": vehicle_info,
                    "vehicle_mirror_info": vehicle_mirror_info,
                    "use_vehicle_mirror": LaunchConfiguration("setup_sensor"),
                }
            ],
            remappings=[
