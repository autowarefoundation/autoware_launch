...
./replace_displays_block.sh $CURRENT_DIR/../autoware.rviz $CURRENT_DIR/../planning_bev.rviz
...
# planning_tpv.rviz
## 1. replace 'Displays:' block
./replace_displays_block.sh $CURRENT_DIR/../autoware.rviz $CURRENT_DIR/../planning_tpv.rviz
## 2. enable Debug/Planning
